...
{
     "orchestral", "dark sci-fi", "retro sci-fi", "fairymusic", "arabesque", "americana", "trash beats","fantasy", "sci-fi", "sports", "popsy", "modern fantasy", "postmodern", "dark fantasy", "adventure", "lament", "comedy", "romance", "crime", "horror", "thriller", "family friendly", "western", "stealth", "mystery"
};
